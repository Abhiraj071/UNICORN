          ...
          <div className="contact-grid">
            ...
            <div className="contact-info-panel">
              ...
              <div className="info-channels-stack">
                ...
                <div className="info-channel-row">
                  ...
                  <div className="channel-texts">
                    ...
                    <a href="tel:+919876543210" className="channel-link">+91 99939 95806</a>
                  </div>
                </div>
                ...
                <div className="info-channel-row">
                  ...
                  <div className="channel-texts">
                    ...
                    <span className="channel-value">Scheme No. 51 , Indore, MP - 452010</span>
                  </div>
                </div>
              </div>
              ...
              <div className="sanctuary-hours-box">
                ...
                <span className="hours-val">Mon – Sat: 10:00 – 18:00 IST</span>
